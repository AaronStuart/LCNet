...
parser.add_argument("--model_path", type=str, default='/home/stuart/PycharmProjects/LCNet/weights/DeepLabV3/model_focal_iter_100000_pretrained.pth')
...
if __name__ == '__main__':
    ...
    with open('experiments/%s/focal_100000_iter_pretrained.json' % model_name, 'w') as result_file:
